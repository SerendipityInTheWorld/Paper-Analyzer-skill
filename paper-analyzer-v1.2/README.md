...
> **Version: V1.2** | [Changelog](#changelog) | [V1.1](#v11-2025-06-06--design-overhaul--bug-fixes) | [V1.0](#v10--initial-release)
...
analysis_schema.json          ← Single source of truth
    ...
    └── scripts/
        ...
        └── generate_report.py ← Unified renderers (console / PDF / JSON / HTML)
                                (V1.2: render_html(), nested bullets in all outputs)
```
